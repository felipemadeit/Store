...
(1,'Macbook Pro Apple M3 Max',19500000,'Apple','A wild beauty. Three giant steps. The MacBook Pro takes off with M3, M3 Pro, and M3 Max chips. Thanks to 3-nanometer technology and a new GPU architecture, they are the most cutting-edge personal computer chips out there. These three little behemoths elevate performance and capabilities to unprecedented levels.\r\n\r\nFeatures:\r\nGraphics that play in another league. Open your eyes wide: you\'re facing a completely new GPU architecture and the most advanced graphics of all Apple chips. Dynamic caching optimizes chip memory to shamelessly increase GPU average usage. The result? A performance boost for the most demanding apps and games. Additionally, games now reach an unprecedented level of detail thanks to hardware-accelerated mesh shading. This technology provides more capacity and efficiency in geometry processing. This way, visually complex scenes can be rendered, achieving breathtaking images.\r\n\r\nHardware-accelerated ray tracing. For the first time, the MacBook Pro uses hardware-accelerated ray tracing. Combined with the new graphics architecture, professional applications now render up to 2.5 times faster, and games display shadows and reflections even more realistically. If you look up \"prodigy\" in the dictionary, this is what you\'ll find.\r\n\r\nOpen until dawn. The MacBook Pro boasts the longest battery life in a Mac, up to 22 hours, which is no small feat. All models perform at their best whether plugged in or not. Moreover, Apple chips are highly efficient, ensuring maximum performance when inspiration or duty calls.\r\n\r\nApps at full throttle. With thousands of applications optimized to harness macOS and Apple chips\' potential, the M3 series boosts performance beyond your imagination. Now apps go turbo: the ones you use every day, for work, and your favorite games.\r\n\r\nThe best display ever seen in a laptop. Extreme dynamic range (XDR) showcases spectacular light effects, detailed shadows, and true-to-life colors. Every Liquid Retina XDR display is factory-calibrated and features ProMotion technology and professional reference profiles. If you look closely, you\'ll fall in love.\r\n\r\nIt has a keen eye. And ear.\r\n\r\n1080p camera. Video calls capture reality more faithfully with technologies that show your best self. Say \"Hello, hello!\" like a radio genius and look radiant even in low light.\r\n\r\nStudio-quality three-microphone array. Captures every nuance in audio production and reduces background noise so you\'re heard loud and clear.\r\n\r\nSix-speaker sound system. Two pairs of woofers with force-canceling and two tweeters are a treat for the ears. Dolby Atmos spatial audio delivers superior three-dimensional sound.\r\n\r\nEverything is connected. The MacBook Pro includes a wide range of ports for high-performance peripherals, high-resolution monitors, and SDXC cards. It also supports Wi-Fi 6E and Bluetooth 5.3 networks. In short, it knows how to connect with friends and strangers alike.\r\n\r\nSecurity that leaves a mark. The Magic Keyboard features standard-height function keys and Touch ID for easy, fast, and secure Mac unlocking and app and website login. Designed to be safe. Your fingerprint information becomes an encrypted mathematical value so you don\'t have to remember tricky passwords.','store/static/media/products/m3_ZdxDkpc.png','store/static/media/products/m3_Ua9nWV4.png',100,3),
(2,'AMD Ryzen 7 5800X 3.8GHz',792000,'AMD','The processor that enables an elite gaming experience. Eight cores optimized for high FPS gaming computers.\r\n\r\nWelcome to the world of the AMD Ryzen 7 5800X processor. This device is a marvel for users who demand high performance and processing speed.\r\n\r\nThe AMD Ryzen 7 5800X operates at a base clock speed of 3.8GHz, allowing you to efficiently handle complex tasks quickly. Its architecture of 8 cores and 16 threads enables seamless multitasking without compromising performance.\r\n\r\nThe AMD Ryzen 7 5800X 3.8GHz is an excellent choice for those seeking top-tier performance in applications and games. Its multi-core processing capability, 3.8GHz clock frequency, and innovative AMD technology deliver a smooth and efficient user experience.\r\n\r\nFeatures:\r\nAMD StoreMI Technology: Software that combines SSD speed with HDD capacity into a single, fast, and easy-to-manage unit, available for free with AMD Series 400 motherboards.\r\nAMD Ryzen™ Master Utility: A simple yet powerful overclocking utility for AMD Ryzen™ processors.\r\nAMD Ryzen™ VR-Ready Premium: For users demanding a premium virtual reality experience, AMD offers specially designed Ryzen™ VR-Ready Premium processors for high performance.','store/static/media/products/m3_GTxtb73.png','store/static/media/products/m3_fBFm0ym.png',100,1);
...
-- Dump completed on 2024-07-24  6:38:38
